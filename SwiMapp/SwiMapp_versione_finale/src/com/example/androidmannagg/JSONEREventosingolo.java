...
public class JSONEREventosingolo {

	Evento _evento;
	String _provincia;
        
        public JSONEREventosingolo(String provincia){
        	//_eventi = new Evento();
        ...
        if(is != null){
            ...
            try{
                    ...
                    for(int i=0;i<jArray.length();i++){
                            ...
                            _evento = new Evento(json_data.getString("paese"),json_data.getDouble("lng"),
