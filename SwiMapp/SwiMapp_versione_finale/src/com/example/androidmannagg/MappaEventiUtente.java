...
public class MappaEventiUtente extends FragmentActivity implements OnMarkerClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView (R.layout.mappaeventiutente);
      ...
      /**---------**/
        ...
        add.setOnClickListener(new View.OnClickListener() {
	        ...
	        public void onClick(View arg0) {
	        	...
	        	Intent nextScreen = new Intent(getApplicationContext(), AggiungiEvento.class);
	...
	public boolean onMarkerClick(Marker m) {
        ...
        Intent nextScreen = new Intent(getApplicationContext(), InformazioniEventoUtente.class);
