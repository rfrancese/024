...
public class ModificaPiscina  extends AsyncTask<String,Void,String>{
   ...
   public ModificaPiscina(String n,String t) throws URISyntaxException, ClientProtocolException, IOException {
   ...
   protected String doInBackground() throws URISyntaxException, ClientProtocolException, IOException {
            ...
            String link = "http://swimapp.altervista.org/modificaPiscina.php?nome="
