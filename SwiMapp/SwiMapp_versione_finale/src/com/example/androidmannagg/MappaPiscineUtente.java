...
public class MappaPiscineUtente extends FragmentActivity implements OnMarkerClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       //lat = 40.875874;
         ...
         setContentView (R.layout.mappapiscineutente);
         ...
         add.setOnClickListener(new View.OnClickListener() {
 	        ...
 	        public void onClick(View arg0) {
 	        	...
 	        	Intent nextScreen = new Intent(getApplicationContext(), AggiungiPiscina.class);
   ...
   Thread t = new Thread(new Runnable(){
	...
	public boolean onMarkerClick(Marker m) {
		 Intent nextScreen = new Intent(getApplicationContext(), InformazioniPiscinaUtente.class);
